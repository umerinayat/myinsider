...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <div class="d-sm-flex align-items-center justify-content-between">
      ...
      <a href="{{ route('insiders.edit', ['insider' => $insider]) }}" class="d-none ml-auto  d-sm-inline-block btn btn-sm btn-success shadow-sm btn-icon-split">
      ...
      <form id="deleteForm" action="{{ route('insiders.destroy', ['insider' => $insider->id]) }}" method="POST">
        @method('DELETE')
        @csrf
