...
@section('page-title')
{{ __('labels.Update') }} {{ $project->project_name }} Data
@endsection
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="d-sm-flex align-items-center justify-content-between">
            <h1 class="h4 mb-0 text-gray-800">{{ __('labels.Update Project') }}</h1>
    ...
    <div class="card-body">
        ...
        <form class="user" method="POST" action="{{ route('projects.update', ['project' => $project->id]) }}">
...
<script> 
        ...
        var projectEndDatePicker = $("#end_date_picker").flatpickr({
            ...
            altFormat:  altFormat,
            dateFormat: dateFormat,
            defaultDate: $('#end_date_picker').val(),
        ...
        if($isProjectCompCheckBox.prop('checked')) {
